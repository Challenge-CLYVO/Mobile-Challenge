...
public class CreatePetDto
{
    ...
    [Required(
        ErrorMessage = "O sexo do pet é obrigatório."
    )]
    [StringLength(
        9,
    ...
    [Required(
        ErrorMessage = "A raça do pet é obrigatória."
    )]
    [StringLength(
        15,
    ...
    [Required(
        ErrorMessage = "A espécie do pet é obrigatória."
    )]
    [StringLength(
        15,
    ...
    [Required(
        ErrorMessage = "A data de nascimento do pet é obrigatória."
    )]
